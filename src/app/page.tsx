        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              {
                service: 'AppSEO' as const,
                illustration: 'AppSEO' as const,
                icon: <TrendingUp className="w-6 h-6 text-amber-600" />,
                iconBg: 'bg-amber-50 border-amber-200',
                title: t('home_svc_aseo_title'),
                desc: t('home_svc_aseo_desc'),
                features: [t('home_svc_aseo_feat1'), t('home_svc_aseo_feat2'), t('home_svc_aseo_feat3'), t('home_svc_aseo_feat4')],
                cta: t('home_svc_aseo_cta'),
                glow: 'blue' as const,
                quoteOnly: true,
              },
              {
                service: 'WebSEO' as const,
                illustration: 'WebSEO' as const,
                icon: <Search className="w-6 h-6 text-sky-600" />,
                iconBg: 'bg-sky-50 border-sky-200',
                title: t('home_svc_wseo_title'),
                desc: t('home_svc_wseo_desc'),
                features: [t('home_svc_wseo_feat1'), t('home_svc_wseo_feat2'), t('home_svc_wseo_feat3'), t('home_svc_wseo_feat4')],
                cta: t('home_svc_wseo_cta'),
                glow: 'blue' as const,
                quoteOnly: true,
              },
              {
                service: 'PageManagement' as const,
                illustration: 'PageManagement' as const,
                icon: <MessageSquare className="w-6 h-6 text-violet-600" />,
                iconBg: 'bg-violet-50 border-violet-200',
                title: t('home_svc_page_title'),
                desc: t('home_svc_page_desc'),
                features: [t('home_svc_page_feat1'), t('home_svc_page_feat2'), t('home_svc_page_feat3'), t('home_svc_page_feat4')],
                cta: t('home_svc_page_cta'),
                glow: 'magenta' as const,
                quoteOnly: true,
              },
            ].map((svc, i) => (
