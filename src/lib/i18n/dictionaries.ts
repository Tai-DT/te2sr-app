...
export const DICTIONARIES: Record<LanguageCode, Record<string, string>> = {
  vi: {
    ...
    adm_price_save: "Lưu giá",
    adm_price_update_failed: "Cập nhật giá thất bại.",
    adm_svc_webtest: "Kiểm Thử Web",
    order_service_webtest: "Kiểm Thử Web",
    home_svc_webtest_title: "Kiểm Thử Website (QA)",
    home_svc_webtest_desc: "Chúng tôi chạy thử website của bạn đúng như một khách hàng thật: bấm qua từng nút, điền từng biểu mẫu, đi hết một lượt mua hàng. Mỗi lỗi tìm được đều kèm ảnh chụp màn hình và các bước tái hiện, để lập trình viên sửa được ngay mà không phải đoán.",
    home_svc_webtest_feat1: "Đi hết mọi luồng: đăng ký, đăng nhập, giỏ hàng, thanh toán, biểu mẫu",
    home_svc_webtest_feat2: "Chrome, Safari, Firefox, Edge — trên điện thoại, máy tính bảng và máy tính",
    home_svc_webtest_feat3: "Đo Core Web Vitals, chỉ đích danh thứ đang làm trang chậm",
    home_svc_webtest_feat4: "Rà lỗi bảo mật thường gặp: biểu mẫu không lọc dữ liệu, lộ thông tin, phân quyền sai",
    home_svc_webtest_cta: "Trao đổi yêu cầu kiểm thử web",
    footer_approval_pledge: "Cam kết tỷ lệ duyệt Store 90%",
    footer_support_channels: "Hỗ trợ 24/7 · Zalo · WhatsApp · Messenger",
    footer_payment_terms: "Thanh toán 2 đợt · Hoàn tiền nếu tester không test đủ",
    order_package_appstore: "Gói App Store ($70)",
    home_price_ios_label: "Đăng Tải App Store",
    home_price_ios_unit: "/ iOS App",
    home_price_ios_split: "Thanh toán 2 đợt ($35 + $35)",
    home_price_ios_feat1: "Đưa app lên App Store Connect",
    home_price_ios_feat2: "Phân phối TestFlight cho người thử",
    home_price_ios_feat3: "Chuẩn bị hồ sơ duyệt theo App Review Guidelines",
    home_price_ios_feat4: "Tối ưu Metadata ASO cơ bản",
    home_price_ios_btn: "Chọn Gói App Store ($70)",
    nav_orders: "Đơn của tôi",
    myorders_title: "Đơn hàng của tôi",
    myorders_subtitle: "Theo dõi tiến độ, tình trạng thanh toán và trao đổi trực tiếp với kỹ sư phụ trách.",
    myorders_loading: "Đang tải đơn hàng…",
    myorders_load_error: "Không tải được danh sách đơn. Vui lòng thử lại.",
    myorders_retry: "Thử lại",
    myorders_signin_title: "Đăng nhập để xem đơn của bạn",
    myorders_signin_desc: "Hãy đăng nhập bằng Google với đúng email bạn đã dùng khi đặt hàng — đơn đặt lúc chưa đăng nhập sẽ tự động hiện ra. Vì bảo mật, đơn chỉ hiển thị khi email đã được Google xác thực.",
    myorders_signin_cta: "Đăng nhập",
    myorders_empty_title: "Chưa có đơn nào",
    myorders_empty_desc: "Bạn chưa đặt dịch vụ nào bằng tài khoản này. Nếu vừa đặt hàng mà không thấy, hãy kiểm tra xem có đang đăng nhập đúng email đã dùng khi đặt không.",
    myorders_empty_cta: "Xem các gói dịch vụ",
    myorders_count_suffix: "đơn",
    myorders_refresh: "Làm mới",
    myorders_quote_price: "Báo giá riêng",
    myorders_chat_show: "Mở trao đổi",
    myorders_chat_hide: "Ẩn trao đổi",
    myorders_chat_loading: "Đang tải tin nhắn…",
    myorders_chat_empty: "Chưa có tin nhắn nào. Hãy gửi câu hỏi cho kỹ sư phụ trách.",
    myorders_chat_placeholder: "Nhập tin nhắn…",
    myorders_chat_send: "Gửi",
    myorders_chat_error: "Không gửi được tin nhắn. Vui lòng thử lại.",
    brand_name: 'TE2SR',
    ...
    hero_subtitle: "Kiểm thử app và website trên thiết bị thật, đưa app lên App Store và Google Play, chạy đủ 12 tester trong 14 ngày theo yêu cầu closed testing của Google Play. Mỗi lỗi bàn giao đều kèm ảnh chụp màn hình và các bước tái hiện.",
    ...
    home_refund_commitment: "Hoàn tiền 100% nếu tester của chúng tôi không test đủ",
    ...
    home_svc_web_title: "Thiết Kế & Lập Trình Website",
    home_svc_web_desc: "Thiết kế và xây dựng website trọn gói: landing page, web bán hàng, trang giới thiệu doanh nghiệp — chuẩn responsive, tối ưu tốc độ và SEO.",
    home_svc_web_feat1: "Thiết kế giao diện riêng theo thương hiệu",
    home_svc_web_feat2: "Chuẩn responsive máy tính & điện thoại",
    home_svc_web_feat3: "Tối ưu tốc độ tải và SEO cơ bản",
    home_svc_web_feat4: "Bàn giao mã nguồn, hỗ trợ tên miền & hosting",
    home_svc_web_cta: "Trao đổi yêu cầu website",
    home_svc_app_title: "Lập Trình Ứng Dụng Di Động",
    home_svc_app_desc: "Phát triển app iOS và Android theo yêu cầu, từ ý tưởng đến khi lên Store — kèm luôn quy trình kiểm thử và đăng tải của TE2SR.",
    home_svc_app_feat1: "Phát triển iOS & Android",
    home_svc_app_feat2: "Thiết kế UI/UX chuẩn Apple & Google",
    home_svc_app_feat3: "Tích hợp API, thanh toán, thông báo đẩy",
    home_svc_app_feat4: "Kèm kiểm thử và đưa lên Store",
    home_svc_app_cta: "Trao đổi yêu cầu app",
    home_svc_aseo_title: "SEO App (ASO — Tối Ưu Từ Khoá Store)",
    home_svc_aseo_desc: "Tối ưu để app hiện lên khi người dùng tìm kiếm trên App Store và Google Play: từ khoá, tiêu đề, mô tả, ảnh chụp màn hình và tỷ lệ cài đặt.",
    home_svc_aseo_feat1: "Nghiên cứu từ khoá theo ngành & đối thủ",
    home_svc_aseo_feat2: "Tối ưu tiêu đề, subtitle, mô tả",
    home_svc_aseo_feat3: "Thiết kế lại ảnh chụp màn hình & icon",
    home_svc_aseo_feat4: "Báo cáo thứ hạng từ khoá hằng tháng",
    home_svc_aseo_cta: "Trao đổi yêu cầu SEO app",
    home_svc_wseo_title: "SEO Website (Google Search)",
    home_svc_wseo_desc: "Đưa website lên trang đầu Google: nghiên cứu từ khoá, tối ưu kỹ thuật, nội dung chuẩn SEO và xây dựng liên kết bền vững.",
    home_svc_wseo_feat1: "Kiểm tra & tối ưu SEO kỹ thuật",
    home_svc_wseo_feat2: "Nghiên cứu từ khoá và bản đồ nội dung",
    home_svc_wseo_feat3: "Tối ưu tốc độ & Core Web Vitals",
    home_svc_wseo_feat4: "Báo cáo thứ hạng và lưu lượng hằng tháng",
    home_svc_wseo_cta: "Trao đổi yêu cầu SEO web",
    home_svc_page_title: "Quản Lý Page & Mạng Xã Hội",
    home_svc_page_desc: "Vận hành fanpage trọn gói: lên kế hoạch nội dung, thiết kế bài đăng, đăng đều đặn, trả lời tin nhắn và bình luận cho khách.",
    home_svc_page_feat1: "Kế hoạch nội dung theo tháng",
    home_svc_page_feat2: "Thiết kế ảnh & viết nội dung bài đăng",
    home_svc_page_feat3: "Đăng bài đều đặn, trả lời inbox & bình luận",
    home_svc_page_feat4: "Báo cáo tương tác và tăng trưởng",
    home_svc_page_cta: "Trao đổi yêu cầu quản lý page",
    svc_quote_on_request: "Báo giá sau khi trao đổi yêu cầu",
    ...
    home_price_refund_fail: "Hoàn tiền 100% nếu tester bên tôi không test đủ theo yêu cầu Google",
    ...
    order_moneyback_badge: "Hoàn tiền 100% nếu Google báo lỗi vì tester của chúng tôi không chạy đủ 12 người trong 14 ngày.",
    ...
    order_service_web: "Thiết Kế Web",
    order_service_appdev: "Làm App",
    order_service_aseo: "SEO App",
    order_service_wseo: "SEO Web",
    order_service_page: "Quản Lý Page",
    order_quote_req_label: "Yêu cầu của bạn",
    order_quote_req_hint: "Mô tả ý tưởng, tính năng mong muốn, thời hạn và ngân sách dự kiến — kỹ sư TE2SR sẽ liên hệ báo giá trong 24 giờ.",
    order_quote_no_payment: "Kỹ sư sẽ liên hệ trao đổi & báo giá trong 24 giờ. Chưa cần thanh toán gì ở bước này.",
    ...
    adm_svc_web: "Thiết kế web",
    adm_svc_appdev: "Làm app",
    adm_svc_aseo: "SEO App",
    adm_svc_wseo: "SEO Web",
    adm_svc_page: "Quản Lý Page",
    ...
    svcp_step4_title: "App Chính Thức Live Trên Store",
  ...
  en: {
    ...
    adm_price_save: "Save price",
    adm_price_update_failed: "Could not update the price.",
    adm_svc_webtest: "Web QA",
    order_service_webtest: "Web QA",
    home_svc_webtest_title: "Website testing (QA)",
    home_svc_webtest_desc: "We work through your site the way a real customer would: pressing every button, filling every form, completing a full purchase. Every bug we find comes with a screenshot and the steps to reproduce it, so your developer can fix it without guessing.",
    home_svc_webtest_feat1: "Every flow walked end to end: sign-up, login, cart, checkout, forms",
    home_svc_webtest_feat2: "Chrome, Safari, Firefox, Edge — on phone, tablet and desktop",
    home_svc_webtest_feat3: "Core Web Vitals measured, with the exact cause of the slowdown named",
    home_svc_webtest_feat4: "Common security holes checked: unfiltered forms, exposed data, broken access control",
    home_svc_webtest_cta: "Discuss your testing needs",
    footer_approval_pledge: "90% store approval rate pledged",
    footer_support_channels: "24/7 support · Zalo · WhatsApp · Messenger",
    footer_payment_terms: "Paid in 2 steps · Refund if our testers fall short",
    order_package_appstore: "App Store package ($70)",
    home_price_ios_label: "App Store publishing",
    home_price_ios_unit: "/ iOS app",
    home_price_ios_split: "Paid in 2 steps ($35 + $35)",
    home_price_ios_feat1: "Submission through App Store Connect",
    home_price_ios_feat2: "TestFlight distribution to testers",
    home_price_ios_feat3: "Review pack prepared to the App Review Guidelines",
    home_price_ios_feat4: "Core ASO metadata optimisation",
    home_price_ios_btn: "Choose App Store ($70)",
    nav_orders: "My orders",
    myorders_title: "My orders",
    myorders_subtitle: "Track progress, payment status, and message the engineer handling your order.",
    myorders_loading: "Loading your orders…",
    myorders_load_error: "Could not load your orders. Please try again.",
    myorders_retry: "Try again",
    myorders_signin_title: "Sign in to see your orders",
    myorders_signin_desc: "Sign in with Google using the same email you used when ordering — orders placed without an account will appear automatically. For security, orders are only shown once Google has verified that email.",
    myorders_signin_cta: "Sign in",
    myorders_empty_title: "No orders yet",
    myorders_empty_desc: "You have not ordered anything with this account. If you just placed an order and cannot see it, check that you are signed in with the same email you used to order.",
    myorders_empty_cta: "Browse our packages",
    myorders_count_suffix: "orders",
    myorders_refresh: "Refresh",
    myorders_quote_price: "Custom quote",
    myorders_chat_show: "Open chat",
    myorders_chat_hide: "Hide chat",
    myorders_chat_loading: "Loading messages…",
    myorders_chat_empty: "No messages yet. Ask your engineer anything.",
    myorders_chat_placeholder: "Type a message…",
    myorders_chat_send: "Send",
    myorders_chat_error: "Message could not be sent. Please try again.",
    brand_name: 'TE2SR',
    ...
    hero_subtitle: "We test apps and websites on real devices, publish to the App Store and Google Play, and run the full 12 testers over 14 days that Google Play closed testing requires. Every bug we hand over comes with a screenshot and the steps to reproduce it.",
    ...
    home_refund_commitment: "Full refund if our testers do not complete the testing",
    ...
    home_svc_web_title: "Website Design & Development",
    home_svc_web_desc: "End-to-end website build: landing pages, e-commerce, company sites — responsive, fast, and SEO-ready.",
    home_svc_web_feat1: "Custom design matched to your brand",
    home_svc_web_feat2: "Responsive on desktop and mobile",
    home_svc_web_feat3: "Speed optimization and basic SEO",
    home_svc_web_feat4: "Source code handover, domain & hosting help",
    home_svc_web_cta: "Discuss your website",
    home_svc_app_title: "Mobile App Development",
    home_svc_app_desc: "Custom iOS and Android apps from idea to Store launch — including TE2SR's testing and publishing pipeline.",
    home_svc_app_feat1: "iOS & Android development",
    home_svc_app_feat2: "UI/UX to Apple & Google standards",
    home_svc_app_feat3: "API, payment and push notification integration",
    home_svc_app_feat4: "Testing and Store publishing included",
    home_svc_app_cta: "Discuss your app",
    home_svc_aseo_title: "App Store Optimization (ASO)",
    home_svc_aseo_desc: "Get your app found when users search the App Store and Google Play: keywords, title, description, screenshots and install conversion.",
    home_svc_aseo_feat1: "Keyword research by category and competitors",
    home_svc_aseo_feat2: "Title, subtitle and description optimization",
    home_svc_aseo_feat3: "Screenshot and icon redesign",
    home_svc_aseo_feat4: "Monthly keyword ranking report",
    home_svc_aseo_cta: "Discuss ASO",
    home_svc_wseo_title: "Website SEO (Google Search)",
    home_svc_wseo_desc: "Get your site onto page one: keyword research, technical fixes, SEO-ready content and sustainable link building.",
    home_svc_wseo_feat1: "Technical SEO audit and fixes",
    home_svc_wseo_feat2: "Keyword research and content mapping",
    home_svc_wseo_feat3: "Speed and Core Web Vitals optimization",
    home_svc_wseo_feat4: "Monthly ranking and traffic report",
    home_svc_wseo_cta: "Discuss website SEO",
    home_svc_page_title: "Social Page Management",
    home_svc_page_desc: "Full fanpage operation: content planning, post design, consistent publishing, and replying to messages and comments for you.",
    home_svc_page_feat1: "Monthly content calendar",
    home_svc_page_feat2: "Post design and copywriting",
    home_svc_page_feat3: "Consistent posting, inbox and comment replies",
    home_svc_page_feat4: "Engagement and growth reporting",
    home_svc_page_cta: "Discuss page management",
    svc_quote_on_request: "Quoted after we discuss your requirements",
    ...
    home_price_refund_fail: "Full refund if our testers fall short of what Google requires",
    ...
    order_moneyback_badge: "Full refund if Google flags the run because our side did not keep 12 testers active for the full 14 days.",
    ...
    order_service_web: "Web Design",
    order_service_appdev: "App Development",
    order_service_aseo: "ASO",
    order_service_wseo: "Web SEO",
    order_service_page: "Page Mgmt",
    order_quote_req_label: "Your requirements",
    order_quote_req_hint: "Describe your idea, the features you want, timeline and rough budget — a TE2SR engineer will reply with a quote within 24 hours.",
    order_quote_no_payment: "An engineer will contact you with a quote within 24 hours. No payment needed at this step.",
    ...
    adm_svc_web: "Web Design",
    adm_svc_appdev: "App Dev",
    adm_svc_aseo: "ASO",
    adm_svc_wseo: "Web SEO",
    adm_svc_page: "Page Mgmt",
    ...
    svcp_step4_title: "App live on the store",
  ...
  ja: {
    ...
    adm_price_save: "金額を保存",
    adm_price_update_failed: "金額を更新できませんでした。",
    adm_svc_webtest: "Webテスト",
    order_service_webtest: "Web検証",
    home_svc_webtest_title: "ウェブサイト検証（QA）",
    home_svc_webtest_desc: "実際のお客さまと同じようにサイトを操作します。すべてのボタンを押し、すべてのフォームを入力し、購入を最後まで通します。発見した不具合にはスクリーンショットと再現手順を添えるため、開発者は推測せずに修正できます。",
    home_svc_webtest_feat1: "登録・ログイン・カート・決済・フォームまで全導線を通しで確認",
    home_svc_webtest_feat2: "Chrome / Safari / Firefox / Edge をスマホ・タブレット・PCで検証",
    home_svc_webtest_feat3: "Core Web Vitals を計測し、遅さの原因を具体的に指摘",
    home_svc_webtest_feat4: "よくある脆弱性を点検：未検証フォーム、情報漏えい、権限設定の不備",
    home_svc_webtest_cta: "検証のご相談",
    footer_approval_pledge: "ストア審査通過率90%をお約束",
    footer_support_channels: "24時間365日サポート · Zalo · WhatsApp · Messenger",
    footer_payment_terms: "2回払い · テスト不足なら返金",
    order_package_appstore: "App Store プラン（$70）",
    home_price_ios_label: "App Store 公開",
    home_price_ios_unit: "/ iOSアプリ",
    home_price_ios_split: "2回払い（$35 + $35）",
    home_price_ios_feat1: "App Store Connect からの申請",
    home_price_ios_feat2: "TestFlight でのテスター配信",
    home_price_ios_feat3: "App Review ガイドラインに沿った審査準備",
    home_price_ios_feat4: "ASOメタデータの基本最適化",
    home_price_ios_btn: "App Store プランを選ぶ（$70）",
    nav_orders: "ご注文",
    myorders_title: "ご注文一覧",
    myorders_subtitle: "進捗・お支払い状況の確認と、担当エンジニアへのご連絡ができます。",
    myorders_loading: "注文を読み込んでいます…",
    myorders_load_error: "注文を読み込めませんでした。もう一度お試しください。",
    myorders_retry: "再試行",
    myorders_signin_title: "ログインして注文を確認",
    myorders_signin_desc: "ご注文時と同じメールアドレスでGoogleログインしてください。アカウントなしで行ったご注文も自動的に表示されます。安全のため、Googleで確認済みのメールアドレスのみ表示されます。",
    myorders_signin_cta: "ログイン",
    myorders_empty_title: "注文はまだありません",
    myorders_empty_desc: "このアカウントでのご注文はありません。ご注文直後に表示されない場合は、注文時と同じメールアドレスでログインしているかご確認ください。",
    myorders_empty_cta: "プランを見る",
    myorders_count_suffix: "件",
    myorders_refresh: "更新",
    myorders_quote_price: "個別見積り",
    myorders_chat_show: "チャットを開く",
    myorders_chat_hide: "チャットを閉じる",
    myorders_chat_loading: "メッセージを読み込み中…",
    myorders_chat_empty: "メッセージはまだありません。お気軽にご質問ください。",
    myorders_chat_placeholder: "メッセージを入力…",
    myorders_chat_send: "送信",
    myorders_chat_error: "送信できませんでした。もう一度お試しください。",
    brand_name: 'TE2SR',
    ...
    hero_subtitle: "実機でアプリとウェブサイトを検証し、App Store と Google Play へ公開します。Google Play のクローズドテストが求める12名・14日間も最後まで運用。お渡しする不具合には必ずスクリーンショットと再現手順を添えます。",
    btn_start: '今すぐ始める',
    ...
    home_refund_commitment: "当社のテスターが検証をやり切れなかった場合は全額返金",
    ...
    home_svc_web_title: "Webサイト制作・開発",
    home_svc_web_desc: "ランディングページ、ECサイト、企業サイトまで一括制作。レスポンシブ対応、高速化、SEO対応済み。",
    home_svc_web_feat1: "ブランドに合わせたオリジナルデザイン",
    home_svc_web_feat2: "PC・スマホ対応のレスポンシブ",
    home_svc_web_feat3: "表示速度の最適化と基本的なSEO",
    home_svc_web_feat4: "ソースコード納品、ドメイン・ホスティング支援",
    home_svc_web_cta: "Webサイトについて相談",
    home_svc_app_title: "モバイルアプリ開発",
    home_svc_app_desc: "iOS・Androidアプリをアイデアからストア公開まで受託開発。TE2SRのテスト・公開代行も込み。",
    home_svc_app_feat1: "iOS・Android開発",
    home_svc_app_feat2: "Apple・Google基準のUI/UX設計",
    home_svc_app_feat3: "API・決済・プッシュ通知の連携",
    home_svc_app_feat4: "テストとストア公開まで対応",
    home_svc_app_cta: "アプリについて相談",
    home_svc_aseo_title: "ASO（アプリストア最適化）",
    home_svc_aseo_desc: "App Store と Google Play の検索でアプリが見つかるよう最適化：キーワード、タイトル、説明文、スクリーンショット、インストール率。",
    home_svc_aseo_feat1: "カテゴリ・競合別のキーワード調査",
    home_svc_aseo_feat2: "タイトル・サブタイトル・説明文の最適化",
    home_svc_aseo_feat3: "スクリーンショットとアイコンの再設計",
    home_svc_aseo_feat4: "毎月のキーワード順位レポート",
    home_svc_aseo_cta: "ASOについて相談",
    home_svc_wseo_title: "Webサイト SEO（Google検索）",
    home_svc_wseo_desc: "サイトを検索1ページ目へ：キーワード調査、技術的改善、SEO対応コンテンツ、持続的な被リンク構築。",
    home_svc_wseo_feat1: "テクニカルSEO監査と改善",
    home_svc_wseo_feat2: "キーワード調査とコンテンツ設計",
    home_svc_wseo_feat3: "表示速度と Core Web Vitals の最適化",
    home_svc_wseo_feat4: "毎月の順位・流入レポート",
    home_svc_wseo_cta: "Web SEOについて相談",
    home_svc_page_title: "SNSページ運用代行",
    home_svc_page_desc: "ページ運用を一括代行：コンテンツ企画、投稿デザイン、定期投稿、メッセージとコメントの返信まで。",
    home_svc_page_feat1: "月次コンテンツカレンダー",
    home_svc_page_feat2: "投稿デザインとライティング",
    home_svc_page_feat3: "定期投稿・DM・コメント対応",
    home_svc_page_feat4: "エンゲージメントと成長レポート",
    home_svc_page_cta: "ページ運用について相談",
    svc_quote_on_request: "要件をお伺いしてからお見積り",
    ...
    home_price_refund_fail: "当社のテスターがGoogleの要件を満たせなければ全額返金",
    ...
    order_moneyback_badge: "当社側で12名のテスターを14日間そろえられず Google から不備を指摘された場合は全額返金します。",
    ...
    order_service_web: "Web制作",
    order_service_appdev: "アプリ開発",
    order_service_aseo: "ASO",
    order_service_wseo: "Web SEO",
    order_service_page: "ページ運用",
    order_quote_req_label: "ご要望",
    order_quote_req_hint: "アイデア、希望する機能、納期、想定予算をご記入ください。TE2SRのエンジニアが24時間以内にお見積りをご連絡します。",
    order_quote_no_payment: "エンジニアが24時間以内にお見積りをご連絡します。この段階でのお支払いは不要です。",
  ...
  ko: {
    ...
    adm_price_save: "금액 저장",
    adm_price_update_failed: "금액을 변경하지 못했습니다.",
    adm_svc_webtest: "웹 QA",
    order_service_webtest: "웹 QA",
    home_svc_webtest_title: "웹사이트 테스트 (QA)",
    home_svc_webtest_desc: "실제 고객처럼 사이트를 사용해 봅니다. 모든 버튼을 눌러 보고, 모든 양식을 채우고, 결제까지 끝까지 진행합니다. 발견한 오류에는 화면 캡처와 재현 순서를 함께 드려 개발자가 추측 없이 바로 고칠 수 있습니다.",
    home_svc_webtest_feat1: "가입·로그인·장바구니·결제·양식까지 전 과정 점검",
    home_svc_webtest_feat2: "Chrome, Safari, Firefox, Edge — 휴대폰·태블릿·PC에서 확인",
    home_svc_webtest_feat3: "Core Web Vitals 측정 후 느려지는 원인을 정확히 지목",
    home_svc_webtest_feat4: "흔한 보안 취약점 점검: 미검증 양식, 정보 노출, 잘못된 권한 설정",
    home_svc_webtest_cta: "테스트 상담하기",
    footer_approval_pledge: "스토어 승인률 90% 보장",
    footer_support_channels: "연중무휴 지원 · Zalo · WhatsApp · Messenger",
    footer_payment_terms: "2회 분할 결제 · 테스트 미달 시 환불",
    order_package_appstore: "App Store 패키지 ($70)",
    home_price_ios_label: "App Store 출시",
    home_price_ios_unit: "/ iOS 앱",
    home_price_ios_split: "2회 분할 결제 ($35 + $35)",
    home_price_ios_feat1: "App Store Connect 심사 제출",
    home_price_ios_feat2: "TestFlight 테스터 배포",
    home_price_ios_feat3: "App Review 가이드라인에 맞춘 심사 준비",
    home_price_ios_feat4: "기본 ASO 메타데이터 최적화",
    home_price_ios_btn: "App Store 패키지 선택 ($70)",
    nav_orders: "내 주문",
    myorders_title: "내 주문",
    myorders_subtitle: "진행 상황과 결제 상태를 확인하고 담당 엔지니어와 바로 소통하세요.",
    myorders_loading: "주문을 불러오는 중…",
    myorders_load_error: "주문을 불러오지 못했습니다. 다시 시도해 주세요.",
    myorders_retry: "다시 시도",
    myorders_signin_title: "로그인하고 주문 확인",
    myorders_signin_desc: "주문할 때 사용한 이메일로 Google 로그인하세요. 로그인 없이 넣은 주문도 자동으로 표시됩니다. 보안을 위해 Google이 확인한 이메일에만 주문이 표시됩니다.",
    myorders_signin_cta: "로그인",
    myorders_empty_title: "아직 주문이 없습니다",
    myorders_empty_desc: "이 계정으로 주문한 내역이 없습니다. 방금 주문했는데 보이지 않으면 주문에 사용한 이메일로 로그인했는지 확인해 주세요.",
    myorders_empty_cta: "서비스 보기",
    myorders_count_suffix: "건",
    myorders_refresh: "새로 고침",
    myorders_quote_price: "개별 견적",
    myorders_chat_show: "채팅 열기",
    myorders_chat_hide: "채팅 닫기",
    myorders_chat_loading: "메시지를 불러오는 중…",
    myorders_chat_empty: "아직 메시지가 없습니다. 무엇이든 문의하세요.",
    myorders_chat_placeholder: "메시지 입력…",
    myorders_chat_send: "보내기",
    myorders_chat_error: "메시지를 보내지 못했습니다. 다시 시도해 주세요.",
    brand_name: 'TE2SR',
    ...
    hero_subtitle: "실제 기기에서 앱과 웹사이트를 테스트하고 App Store와 Google Play에 출시합니다. Google Play 비공개 테스트에 필요한 테스터 12명·14일도 끝까지 운영합니다. 전달하는 모든 오류에는 화면 캡처와 재현 순서를 함께 드립니다.",
    btn_start: '지금 시작하기',
    ...
    home_refund_commitment: "저희 테스터가 테스트를 채우지 못하면 전액 환불",
    ...
    home_svc_web_title: "웹사이트 디자인 & 개발",
    home_svc_web_desc: "랜딩 페이지, 쇼핑몰, 기업 사이트까지 전체 제작. 반응형, 속도 최적화, SEO 대응.",
    home_svc_web_feat1: "브랜드에 맞춘 맞춤 디자인",
    home_svc_web_feat2: "PC·모바일 반응형 대응",
    home_svc_web_feat3: "속도 최적화 및 기본 SEO",
    home_svc_web_feat4: "소스 코드 인계, 도메인·호스팅 지원",
    home_svc_web_cta: "웹사이트 요건 상담",
    home_svc_app_title: "모바일 앱 개발",
    home_svc_app_desc: "아이디어부터 스토어 출시까지 iOS·Android 앱 맞춤 개발. TE2SR의 테스트·등록 과정 포함.",
    home_svc_app_feat1: "iOS & Android 개발",
    home_svc_app_feat2: "Apple·Google 기준 UI/UX 설계",
    home_svc_app_feat3: "API·결제·푸시 알림 연동",
    home_svc_app_feat4: "테스트 및 스토어 등록 포함",
    home_svc_app_cta: "앱 요건 상담",
    home_svc_aseo_title: "ASO (앱스토어 최적화)",
    home_svc_aseo_desc: "App Store와 Google Play 검색에서 앱이 노출되도록 최적화: 키워드, 제목, 설명, 스크린샷, 설치 전환율.",
    home_svc_aseo_feat1: "카테고리·경쟁사 기반 키워드 조사",
    home_svc_aseo_feat2: "제목·부제·설명 최적화",
    home_svc_aseo_feat3: "스크린샷 및 아이콘 리디자인",
    home_svc_aseo_feat4: "월간 키워드 순위 리포트",
    home_svc_aseo_cta: "ASO 상담",
    home_svc_wseo_title: "웹사이트 SEO (구글 검색)",
    home_svc_wseo_desc: "사이트를 검색 첫 페이지로: 키워드 조사, 기술 최적화, SEO 콘텐츠, 지속 가능한 링크 빌딩.",
    home_svc_wseo_feat1: "기술 SEO 진단 및 개선",
    home_svc_wseo_feat2: "키워드 조사와 콘텐츠 설계",
    home_svc_wseo_feat3: "속도 및 Core Web Vitals 최적화",
    home_svc_wseo_feat4: "월간 순위·트래픽 리포트",
    home_svc_wseo_cta: "웹 SEO 상담",
    home_svc_page_title: "SNS 페이지 운영 대행",
    home_svc_page_desc: "페이지 운영 일괄 대행: 콘텐츠 기획, 게시물 디자인, 정기 발행, 메시지와 댓글 응대까지.",
    home_svc_page_feat1: "월간 콘텐츠 캘린더",
    home_svc_page_feat2: "게시물 디자인 및 카피라이팅",
    home_svc_page_feat3: "정기 게시, 메시지·댓글 응대",
    home_svc_page_feat4: "참여도 및 성장 리포트",
    home_svc_page_cta: "페이지 운영 상담",
    svc_quote_on_request: "요건 상담 후 견적 안내",
    ...
    home_price_refund_fail: "저희 테스터가 Google 요건을 채우지 못하면 전액 환불",
    ...
    order_moneyback_badge: "저희 쪽에서 테스터 12명을 14일간 유지하지 못해 Google이 문제를 통보하면 전액 환불합니다.",
    ...
    order_service_web: "웹 제작",
    order_service_appdev: "앱 개발",
    order_service_aseo: "ASO",
    order_service_wseo: "웹 SEO",
    order_service_page: "페이지 운영",
    order_quote_req_label: "요청 사항",
    order_quote_req_hint: "아이디어, 원하는 기능, 일정, 예상 예산을 적어주세요. TE2SR 엔지니어가 24시간 내 견적을 드립니다.",
    order_quote_no_payment: "엔지니어가 24시간 내 견적을 안내드립니다. 이 단계에서는 결제가 필요 없습니다.",
  ...
  fr: {
    ...
    adm_price_save: "Enregistrer",
    adm_price_update_failed: "Impossible de mettre à jour le montant.",
    adm_svc_webtest: "QA Web",
    order_service_webtest: "Test web",
    home_svc_webtest_title: "Test de site web (QA)",
    home_svc_webtest_desc: "Nous parcourons votre site comme le ferait un vrai client : chaque bouton pressé, chaque formulaire rempli, un achat mené jusqu'au bout. Chaque anomalie trouvée est accompagnée d'une capture d'écran et des étapes pour la reproduire, afin que votre développeur corrige sans deviner.",
    home_svc_webtest_feat1: "Tous les parcours testés : inscription, connexion, panier, paiement, formulaires",
    home_svc_webtest_feat2: "Chrome, Safari, Firefox, Edge — sur mobile, tablette et ordinateur",
    home_svc_webtest_feat3: "Core Web Vitals mesurés, avec la cause précise des lenteurs",
    home_svc_webtest_feat4: "Failles courantes vérifiées : formulaires non filtrés, données exposées, droits mal configurés",
    home_svc_webtest_cta: "Discuter de vos besoins de test",
    footer_approval_pledge: "Taux d’approbation garanti à 90 %",
    footer_support_channels: "Assistance 24/7 · Zalo · WhatsApp · Messenger",
    footer_payment_terms: "Paiement en 2 fois · Remboursé si test incomplet",
    order_package_appstore: "Offre App Store (70 $)",
    home_price_ios_label: "Publication App Store",
    home_price_ios_unit: "/ app iOS",
    home_price_ios_split: "Paiement en 2 fois (35 $ + 35 $)",
    home_price_ios_feat1: "Soumission via App Store Connect",
    home_price_ios_feat2: "Distribution TestFlight aux testeurs",
    home_price_ios_feat3: "Dossier de validation conforme aux App Review Guidelines",
    home_price_ios_feat4: "Optimisation ASO des métadonnées",
    home_price_ios_btn: "Choisir l'offre App Store (70 $)",
    nav_orders: "Mes commandes",
    myorders_title: "Mes commandes",
    myorders_subtitle: "Suivez l'avancement, l'état des paiements et échangez avec l'ingénieur en charge.",
    myorders_loading: "Chargement de vos commandes…",
    myorders_load_error: "Impossible de charger vos commandes. Veuillez réessayer.",
    myorders_retry: "Réessayer",
    myorders_signin_title: "Connectez-vous pour voir vos commandes",
    myorders_signin_desc: "Connectez-vous avec Google en utilisant l'adresse e-mail employée lors de la commande — les commandes passées sans compte apparaîtront automatiquement. Par sécurité, elles ne s'affichent qu'une fois l'adresse vérifiée par Google.",
    myorders_signin_cta: "Se connecter",
    myorders_empty_title: "Aucune commande",
    myorders_empty_desc: "Aucune commande n'est associée à ce compte. Si vous venez de commander sans la voir, vérifiez que vous êtes connecté avec la même adresse e-mail.",
    myorders_empty_cta: "Voir nos offres",
    myorders_count_suffix: "commandes",
    myorders_refresh: "Actualiser",
    myorders_quote_price: "Devis sur mesure",
    myorders_chat_show: "Ouvrir la discussion",
    myorders_chat_hide: "Masquer la discussion",
    myorders_chat_loading: "Chargement des messages…",
    myorders_chat_empty: "Aucun message. Posez vos questions à l'ingénieur.",
    myorders_chat_placeholder: "Écrire un message…",
    myorders_chat_send: "Envoyer",
    myorders_chat_error: "Le message n'a pas pu être envoyé. Veuillez réessayer.",
    brand_name: 'TE2SR',
    ...
    hero_subtitle: "Nous testons applications et sites sur appareils réels, publions sur l'App Store et Google Play, et menons les 12 testeurs sur 14 jours qu'exige le test fermé de Google Play. Chaque anomalie livrée est accompagnée d'une capture d'écran et des étapes pour la reproduire.",
    ...
    home_refund_commitment: "Remboursement intégral si nos testeurs ne vont pas au bout",
    ...
    home_svc_web_title: "Conception & Développement de Sites Web",
    home_svc_web_desc: "Création de site clé en main : landing page, e-commerce, site vitrine — responsive, rapide et optimisé SEO.",
    home_svc_web_feat1: "Design sur mesure aux couleurs de votre marque",
    home_svc_web_feat2: "Responsive sur ordinateur et mobile",
    home_svc_web_feat3: "Optimisation de la vitesse et SEO de base",
    home_svc_web_feat4: "Remise du code source, aide domaine & hébergement",
    home_svc_web_cta: "Discuter de votre site",
    home_svc_app_title: "Développement d'Applications Mobiles",
    home_svc_app_desc: "Applications iOS et Android sur mesure, de l'idée à la mise en ligne — incluant les tests et la publication TE2SR.",
    home_svc_app_feat1: "Développement iOS & Android",
    home_svc_app_feat2: "UI/UX aux standards Apple & Google",
    home_svc_app_feat3: "Intégration API, paiement et notifications push",
    home_svc_app_feat4: "Tests et publication sur les stores inclus",
    home_svc_app_cta: "Discuter de votre application",
    home_svc_aseo_title: "ASO (Optimisation App Store)",
    home_svc_aseo_desc: "Rendez votre app visible dans les recherches App Store et Google Play : mots-clés, titre, description, captures et taux d'installation.",
    home_svc_aseo_feat1: "Recherche de mots-clés par catégorie et concurrents",
    home_svc_aseo_feat2: "Optimisation du titre, sous-titre et description",
    home_svc_aseo_feat3: "Refonte des captures d'écran et de l'icône",
    home_svc_aseo_feat4: "Rapport mensuel de positionnement",
    home_svc_aseo_cta: "Discuter de l'ASO",
    home_svc_wseo_title: "SEO de Site Web (Google)",
    home_svc_wseo_desc: "Placez votre site en première page : recherche de mots-clés, corrections techniques, contenu optimisé et netlinking durable.",
    home_svc_wseo_feat1: "Audit SEO technique et corrections",
    home_svc_wseo_feat2: "Recherche de mots-clés et plan de contenu",
    home_svc_wseo_feat3: "Optimisation vitesse et Core Web Vitals",
    home_svc_wseo_feat4: "Rapport mensuel de position et trafic",
    home_svc_wseo_cta: "Discuter du SEO web",
    home_svc_page_title: "Gestion de Page & Réseaux Sociaux",
    home_svc_page_desc: "Gestion complète de votre page : planning éditorial, design des publications, publication régulière, réponses aux messages et commentaires.",
    home_svc_page_feat1: "Calendrier de contenu mensuel",
    home_svc_page_feat2: "Design des posts et rédaction",
    home_svc_page_feat3: "Publication régulière, réponses aux messages",
    home_svc_page_feat4: "Rapport d'engagement et de croissance",
    home_svc_page_cta: "Discuter de la gestion de page",
    svc_quote_on_request: "Devis après échange sur vos besoins",
    ...
    home_price_refund_fail: "Remboursement intégral si nos testeurs n'atteignent pas les exigences de Google",
    ...
    order_moneyback_badge: "Remboursement intégral si Google signale un problème parce que nous n'avons pas maintenu 12 testeurs pendant les 14 jours.",
    ...
    order_service_web: "Site Web",
    order_service_appdev: "Développement App",
    order_service_aseo: "ASO",
    order_service_wseo: "SEO Web",
    order_service_page: "Gestion Page",
    order_quote_req_label: "Votre besoin",
    order_quote_req_hint: "Décrivez votre idée, les fonctionnalités souhaitées, le délai et le budget envisagé — un ingénieur TE2SR vous enverra un devis sous 24 heures.",
    order_quote_no_payment: "Un ingénieur vous contactera avec un devis sous 24 heures. Aucun paiement à cette étape.",
    ...
    adm_svc_web: "Site Web",
    adm_svc_appdev: "Dév. App",
    adm_svc_aseo: "ASO",
    adm_svc_wseo: "SEO Web",
    adm_svc_page: "Gestion Page",
    ...
    svcp_step4_title: "Application publiée sur le store",
  ...
  de: {
    ...
    adm_price_save: "Betrag speichern",
    adm_price_update_failed: "Der Betrag konnte nicht aktualisiert werden.",
    adm_svc_webtest: "Web-QA",
    order_service_webtest: "Web-QA",
    home_svc_webtest_title: "Website-Test (QA)",
    home_svc_webtest_desc: "Wir gehen Ihre Website durch wie ein echter Kunde: jeder Button gedrückt, jedes Formular ausgefüllt, ein Kauf komplett abgeschlossen. Zu jedem gefundenen Fehler liefern wir einen Screenshot und die Schritte zum Nachstellen — Ihr Entwickler muss nicht raten.",
    home_svc_webtest_feat1: "Alle Abläufe durchgespielt: Registrierung, Login, Warenkorb, Bezahlung, Formulare",
    home_svc_webtest_feat2: "Chrome, Safari, Firefox, Edge — auf Handy, Tablet und Rechner",
    home_svc_webtest_feat3: "Core Web Vitals gemessen, mit konkret benannter Ursache der Verzögerung",
    home_svc_webtest_feat4: "Gängige Sicherheitslücken geprüft: ungefilterte Formulare, offengelegte Daten, falsche Rechte",
    home_svc_webtest_cta: "Testbedarf besprechen",
    ...
    footer_payment_terms: "Zahlung in 2 Raten · Rückerstattung bei unvollständigem Test",
    order_package_appstore: "App-Store-Paket (70 $)",
    home_price_ios_label: "App-Store-Veröffentlichung",
    home_price_ios_unit: "/ iOS-App",
    home_price_ios_split: "Zahlung in 2 Raten (35 $ + 35 $)",
    home_price_ios_feat1: "Einreichung über App Store Connect",
    home_price_ios_feat2: "TestFlight-Verteilung an Tester",
    home_price_ios_feat3: "Prüfunterlagen nach den App Review Guidelines",
    home_price_ios_feat4: "Grundlegende ASO-Metadaten-Optimierung",
    home_price_ios_btn: "App-Store-Paket wählen (70 $)",
    nav_orders: "Meine Bestellungen",
    myorders_title: "Meine Bestellungen",
    myorders_subtitle: "Fortschritt und Zahlungsstatus verfolgen und direkt mit dem zuständigen Techniker schreiben.",
    myorders_loading: "Bestellungen werden geladen…",
    myorders_load_error: "Bestellungen konnten nicht geladen werden. Bitte erneut versuchen.",
    myorders_retry: "Erneut versuchen",
    myorders_signin_title: "Anmelden, um Bestellungen zu sehen",
    myorders_signin_desc: "Melden Sie sich mit Google und derselben E-Mail-Adresse an, die Sie bei der Bestellung verwendet haben — ohne Konto aufgegebene Bestellungen erscheinen automatisch. Aus Sicherheitsgründen werden Bestellungen erst angezeigt, wenn Google die Adresse bestätigt hat.",
    myorders_signin_cta: "Anmelden",
    myorders_empty_title: "Noch keine Bestellungen",
    myorders_empty_desc: "Mit diesem Konto wurde noch nichts bestellt. Falls Sie gerade bestellt haben und nichts sehen, prüfen Sie, ob Sie mit derselben E-Mail-Adresse angemeldet sind.",
    myorders_empty_cta: "Pakete ansehen",
    myorders_count_suffix: "Bestellungen",
    myorders_refresh: "Aktualisieren",
    myorders_quote_price: "Individuelles Angebot",
    myorders_chat_show: "Chat öffnen",
    myorders_chat_hide: "Chat ausblenden",
    myorders_chat_loading: "Nachrichten werden geladen…",
    myorders_chat_empty: "Noch keine Nachrichten. Fragen Sie Ihren Techniker.",
    myorders_chat_placeholder: "Nachricht schreiben…",
    myorders_chat_send: "Senden",
    myorders_chat_error: "Nachricht konnte nicht gesendet werden. Bitte erneut versuchen.",
    brand_name: 'TE2SR',
    ...
    hero_subtitle: "Wir testen Apps und Websites auf echten Geräten, veröffentlichen im App Store und bei Google Play und führen die 12 Tester über 14 Tage durch, die Google Plays Closed Testing verlangt. Zu jedem übergebenen Fehler gehören ein Screenshot und die Schritte zum Nachstellen.",
    ...
    home_refund_commitment: "Volle Rückerstattung, wenn unsere Tester nicht vollständig testen",
    ...
    home_svc_web_title: "Website-Design & -Entwicklung",
    home_svc_web_desc: "Komplette Website-Erstellung: Landingpages, Onlineshops, Unternehmensseiten — responsiv, schnell und SEO-fertig.",
    home_svc_web_feat1: "Individuelles Design passend zur Marke",
    home_svc_web_feat2: "Responsiv auf Desktop und Mobilgerät",
    home_svc_web_feat3: "Geschwindigkeitsoptimierung und Basis-SEO",
    home_svc_web_feat4: "Quellcode-Übergabe, Domain- & Hosting-Hilfe",
    home_svc_web_cta: "Website-Anforderungen besprechen",
    home_svc_app_title: "Mobile-App-Entwicklung",
    home_svc_app_desc: "Individuelle iOS- und Android-Apps von der Idee bis zum Store-Launch — inklusive Tests und Veröffentlichung durch TE2SR.",
    home_svc_app_feat1: "iOS- & Android-Entwicklung",
    home_svc_app_feat2: "UI/UX nach Apple- & Google-Standards",
    home_svc_app_feat3: "API-, Zahlungs- und Push-Benachrichtigungs-Integration",
    home_svc_app_feat4: "Tests und Store-Veröffentlichung inklusive",
    home_svc_app_cta: "App-Anforderungen besprechen",
    home_svc_aseo_title: "ASO (App-Store-Optimierung)",
    home_svc_aseo_desc: "Machen Sie Ihre App in der Suche im App Store und bei Google Play auffindbar: Keywords, Titel, Beschreibung, Screenshots und Installationsrate.",
    home_svc_aseo_feat1: "Keyword-Recherche nach Kategorie und Wettbewerb",
    home_svc_aseo_feat2: "Optimierung von Titel, Untertitel und Beschreibung",
    home_svc_aseo_feat3: "Neugestaltung von Screenshots und Icon",
    home_svc_aseo_feat4: "Monatlicher Keyword-Ranking-Bericht",
    home_svc_aseo_cta: "ASO besprechen",
    home_svc_wseo_title: "Website-SEO (Google-Suche)",
    home_svc_wseo_desc: "Bringen Sie Ihre Website auf Seite eins: Keyword-Recherche, technische Optimierung, SEO-Inhalte und nachhaltiger Linkaufbau.",
    home_svc_wseo_feat1: "Technisches SEO-Audit und Korrekturen",
    home_svc_wseo_feat2: "Keyword-Recherche und Content-Mapping",
    home_svc_wseo_feat3: "Geschwindigkeit und Core Web Vitals optimieren",
    home_svc_wseo_feat4: "Monatlicher Ranking- und Traffic-Bericht",
    home_svc_wseo_cta: "Website-SEO besprechen",
    home_svc_page_title: "Social-Media-Seitenbetreuung",
    home_svc_page_desc: "Komplette Seitenbetreuung: Contentplanung, Post-Design, regelmäßiges Posten sowie Antworten auf Nachrichten und Kommentare.",
    home_svc_page_feat1: "Monatlicher Content-Kalender",
    home_svc_page_feat2: "Post-Design und Texterstellung",
    home_svc_page_feat3: "Regelmäßiges Posten, Nachrichten- und Kommentarbetreuung",
    home_svc_page_feat4: "Bericht zu Interaktion und Wachstum",
    home_svc_page_cta: "Seitenbetreuung besprechen",
    svc_quote_on_request: "Angebot nach Klärung Ihrer Anforderungen",
    ...
    home_price_refund_fail: "Volle Rückerstattung, wenn unsere Tester Googles Vorgaben verfehlen",
    ...
    order_moneyback_badge: "Volle Rückerstattung, wenn Google beanstandet, dass wir die 12 Tester nicht über die vollen 14 Tage gehalten haben.",
    ...
    order_service_promotion: "5★ Boost",
    order_service_web: "Webdesign",
    order_service_appdev: "App-Entwicklung",
    order_service_aseo: "ASO",
    order_service_wseo: "Web-SEO",
    order_service_page: "Seitenbetreuung",
    order_quote_req_label: "Ihre Anforderungen",
    order_quote_req_hint: "Beschreiben Sie Ihre Idee, gewünschte Funktionen, Zeitrahmen und ungefähres Budget — ein TE2SR-Ingenieur meldet sich innerhalb von 24 Stunden mit einem Angebot.",
    order_quote_no_payment: "Ein Ingenieur meldet sich innerhalb von 24 Stunden mit einem Angebot. In diesem Schritt ist keine Zahlung nötig.",
    ...
    adm_svc_web: "Webdesign",
    adm_svc_appdev: "App-Dev",
    adm_svc_aseo: "ASO",
    adm_svc_wseo: "Web-SEO",
    adm_svc_page: "Seitenbetreuung",
    adm_svc_promotion: "5★ Boost",
    adm_svc_publishing: "App Store",
    ...
    svcp_step4_title: "App im Store live",
  ...
  es: {
    ...
    adm_price_save: "Guardar importe",
    adm_price_update_failed: "No se pudo actualizar el importe.",
    adm_svc_webtest: "QA Web",
    order_service_webtest: "QA web",
    home_svc_webtest_title: "Pruebas de sitio web (QA)",
    home_svc_webtest_desc: "Recorremos tu sitio como lo haría un cliente real: pulsamos cada botón, rellenamos cada formulario y completamos una compra entera. Cada fallo que encontramos viene con captura de pantalla y los pasos para reproducirlo, para que tu desarrollador lo corrija sin adivinar.",
    home_svc_webtest_feat1: "Todos los flujos recorridos: registro, acceso, carrito, pago, formularios",
    home_svc_webtest_feat2: "Chrome, Safari, Firefox, Edge — en móvil, tablet y ordenador",
    home_svc_webtest_feat3: "Core Web Vitals medidos, señalando la causa exacta de la lentitud",
    home_svc_webtest_feat4: "Fallos de seguridad habituales revisados: formularios sin filtrar, datos expuestos, permisos mal puestos",
    home_svc_webtest_cta: "Hablemos de tus pruebas",
    footer_approval_pledge: "90 % de aprobación garantizada",
    footer_support_channels: "Soporte 24/7 · Zalo · WhatsApp · Messenger",
    footer_payment_terms: "Pago en 2 partes · Reembolso si las pruebas no se completan",
    order_package_appstore: "Paquete App Store (70 $)",
    home_price_ios_label: "Publicación en App Store",
    home_price_ios_unit: "/ app iOS",
    home_price_ios_split: "Pago en 2 partes (35 $ + 35 $)",
    home_price_ios_feat1: "Envío a través de App Store Connect",
    home_price_ios_feat2: "Distribución TestFlight a los testers",
    home_price_ios_feat3: "Expediente de revisión según las App Review Guidelines",
    home_price_ios_feat4: "Optimización básica de metadatos ASO",
    home_price_ios_btn: "Elegir App Store (70 $)",
    nav_orders: "Mis pedidos",
    myorders_title: "Mis pedidos",
    myorders_subtitle: "Sigue el progreso, el estado del pago y habla directamente con el ingeniero asignado.",
    myorders_loading: "Cargando tus pedidos…",
    myorders_load_error: "No se pudieron cargar tus pedidos. Inténtalo de nuevo.",
    myorders_retry: "Reintentar",
    myorders_signin_title: "Inicia sesión para ver tus pedidos",
    myorders_signin_desc: "Inicia sesión con Google usando el mismo correo con el que hiciste el pedido: los pedidos hechos sin cuenta aparecerán automáticamente. Por seguridad, solo se muestran cuando Google ha verificado ese correo.",
    myorders_signin_cta: "Iniciar sesión",
    myorders_empty_title: "Aún no hay pedidos",
    myorders_empty_desc: "No has contratado nada con esta cuenta. Si acabas de hacer un pedido y no lo ves, comprueba que has iniciado sesión con el mismo correo.",
    myorders_empty_cta: "Ver los paquetes",
    myorders_count_suffix: "pedidos",
    myorders_refresh: "Actualizar",
    myorders_quote_price: "Presupuesto a medida",
    myorders_chat_show: "Abrir chat",
    myorders_chat_hide: "Ocultar chat",
    myorders_chat_loading: "Cargando mensajes…",
    myorders_chat_empty: "Aún no hay mensajes. Pregunta lo que necesites.",
    myorders_chat_placeholder: "Escribe un mensaje…",
    myorders_chat_send: "Enviar",
    myorders_chat_error: "No se pudo enviar el mensaje. Inténtalo de nuevo.",
    brand_name: 'TE2SR',
    ...
    hero_subtitle: "Probamos apps y sitios web en dispositivos reales, publicamos en App Store y Google Play, y completamos los 12 testers durante 14 días que exige la prueba cerrada de Google Play. Cada fallo que entregamos lleva captura de pantalla y los pasos para reproducirlo.",
    ...
    home_refund_commitment: "Reembolso completo si nuestros testers no completan las pruebas",
    ...
    home_svc_web_title: "Diseño y Desarrollo de Sitios Web",
    home_svc_web_desc: "Creación integral de sitios: landing pages, tiendas online, webs corporativas — responsive, rápidas y listas para SEO.",
    home_svc_web_feat1: "Diseño a medida acorde a tu marca",
    home_svc_web_feat2: "Responsive en ordenador y móvil",
    home_svc_web_feat3: "Optimización de velocidad y SEO básico",
    home_svc_web_feat4: "Entrega del código fuente, ayuda con dominio y hosting",
    home_svc_web_cta: "Hablemos de tu sitio web",
    home_svc_app_title: "Desarrollo de Aplicaciones Móviles",
    home_svc_app_desc: "Apps iOS y Android a medida, de la idea al lanzamiento en la tienda — incluye pruebas y publicación de TE2SR.",
    home_svc_app_feat1: "Desarrollo iOS y Android",
    home_svc_app_feat2: "UI/UX según estándares de Apple y Google",
    home_svc_app_feat3: "Integración de API, pagos y notificaciones push",
    home_svc_app_feat4: "Pruebas y publicación en tiendas incluidas",
    home_svc_app_cta: "Hablemos de tu app",
    home_svc_aseo_title: "ASO (Optimización en App Store)",
    home_svc_aseo_desc: "Haz que encuentren tu app al buscar en la App Store y Google Play: palabras clave, título, descripción, capturas y tasa de instalación.",
    home_svc_aseo_feat1: "Investigación de palabras clave por categoría y competencia",
    home_svc_aseo_feat2: "Optimización de título, subtítulo y descripción",
    home_svc_aseo_feat3: "Rediseño de capturas de pantalla e icono",
    home_svc_aseo_feat4: "Informe mensual de posiciones",
    home_svc_aseo_cta: "Hablemos de ASO",
    home_svc_wseo_title: "SEO de Sitio Web (Google)",
    home_svc_wseo_desc: "Lleva tu web a la primera página: investigación de palabras clave, correcciones técnicas, contenido optimizado y enlaces sostenibles.",
    home_svc_wseo_feat1: "Auditoría SEO técnica y correcciones",
    home_svc_wseo_feat2: "Investigación de palabras clave y mapa de contenidos",
    home_svc_wseo_feat3: "Optimización de velocidad y Core Web Vitals",
    home_svc_wseo_feat4: "Informe mensual de posiciones y tráfico",
    home_svc_wseo_cta: "Hablemos de SEO web",
    home_svc_page_title: "Gestión de Páginas y Redes Sociales",
    home_svc_page_desc: "Gestión integral de tu página: plan de contenidos, diseño de publicaciones, publicación constante y respuesta a mensajes y comentarios.",
    home_svc_page_feat1: "Calendario de contenidos mensual",
    home_svc_page_feat2: "Diseño de publicaciones y redacción",
    home_svc_page_feat3: "Publicación constante, respuesta a mensajes y comentarios",
    home_svc_page_feat4: "Informe de interacción y crecimiento",
    home_svc_page_cta: "Hablemos de gestión de página",
    svc_quote_on_request: "Presupuesto tras conversar sobre tus necesidades",
    ...
    home_price_refund_fail: "Reembolso completo si nuestros testers no cumplen lo que exige Google",
    ...
    order_moneyback_badge: "Reembolso completo si Google señala un fallo porque no mantuvimos 12 testers durante los 14 días.",
    ...
    order_service_web: "Diseño Web",
    order_service_appdev: "Desarrollo App",
    order_service_aseo: "ASO",
    order_service_wseo: "SEO Web",
    order_service_page: "Gestión Página",
    order_quote_req_label: "Tus requisitos",
    order_quote_req_hint: "Describe tu idea, las funciones que quieres, el plazo y el presupuesto aproximado — un ingeniero de TE2SR te enviará un presupuesto en 24 horas.",
    order_quote_no_payment: "Un ingeniero te contactará con un presupuesto en 24 horas. No hace falta pagar nada en este paso.",
    ...
    adm_svc_web: "Diseño Web",
    adm_svc_appdev: "Desarrollo App",
    adm_svc_aseo: "ASO",
    adm_svc_wseo: "SEO Web",
    adm_svc_page: "Gestión Página",
    ...
    svcp_step4_title: "App publicada en la tienda",
  ...
  zh: {
    ...
    adm_price_save: "保存金额",
    adm_price_update_failed: "更新金额失败。",
    adm_svc_webtest: "网站测试",
    order_service_webtest: "网站测试",
    home_svc_webtest_title: "网站测试（QA）",
    home_svc_webtest_desc: "我们像真实顾客一样把网站走一遍：每个按钮都点，每个表单都填，完整走完一次下单。发现的每个问题都附上截图和复现步骤，开发人员不用猜就能修。",
    home_svc_webtest_feat1: "完整走查各流程：注册、登录、购物车、结算、表单",
    home_svc_webtest_feat2: "Chrome、Safari、Firefox、Edge —— 手机、平板、电脑全覆盖",
    home_svc_webtest_feat3: "实测 Core Web Vitals，明确指出拖慢页面的具体原因",
    home_svc_webtest_feat4: "排查常见安全隐患：表单未过滤、信息泄露、权限配置错误",
    home_svc_webtest_cta: "沟通网站测试需求",
    footer_approval_pledge: "承诺 90% 商店过审率",
    footer_support_channels: "7×24 小时支持 · Zalo · WhatsApp · Messenger",
    footer_payment_terms: "分两期支付 · 测试不足则退款",
    order_package_appstore: "App Store 套餐（$70）",
    home_price_ios_label: "App Store 上架",
    home_price_ios_unit: "/ iOS 应用",
    home_price_ios_split: "分两期支付（$35 + $35）",
    home_price_ios_feat1: "通过 App Store Connect 提交审核",
    home_price_ios_feat2: "TestFlight 分发给测试人员",
    home_price_ios_feat3: "按 App Review Guidelines 准备审核材料",
    home_price_ios_feat4: "基础 ASO 元数据优化",
    home_price_ios_btn: "选择 App Store 套餐（$70）",
    nav_orders: "我的订单",
    myorders_title: "我的订单",
    myorders_subtitle: "查看进度与付款状态，并直接与负责的工程师沟通。",
    myorders_loading: "正在加载订单…",
    myorders_load_error: "无法加载订单，请重试。",
    myorders_retry: "重试",
    myorders_signin_title: "登录后查看订单",
    myorders_signin_desc: "请使用下单时的同一邮箱通过 Google 登录，未注册账户时下的订单会自动显示。出于安全考虑，只有经 Google 验证的邮箱才会显示订单。",
    myorders_signin_cta: "登录",
    myorders_empty_title: "暂无订单",
    myorders_empty_desc: "此账户还没有订单。如果刚下单却看不到，请确认登录邮箱与下单时一致。",
    myorders_empty_cta: "查看服务套餐",
    myorders_count_suffix: "个订单",
    myorders_refresh: "刷新",
    myorders_quote_price: "专属报价",
    myorders_chat_show: "展开沟通",
    myorders_chat_hide: "收起沟通",
    myorders_chat_loading: "正在加载消息…",
    myorders_chat_empty: "暂无消息，有问题随时提出。",
    myorders_chat_placeholder: "输入消息…",
    myorders_chat_send: "发送",
    myorders_chat_error: "消息发送失败，请重试。",
    brand_name: 'TE2SR',
    ...
    hero_subtitle: "我们在真实设备上测试应用与网站，上架 App Store 与 Google Play，并完整运行 Google Play 封闭测试所要求的 12 位测试员、14 天。交付的每个问题都附有截图和复现步骤。",
    btn_start: '立即开始',
    ...
    home_refund_commitment: "若我方测试员未完成测试，全额退款",
    ...
    home_svc_web_title: "网站设计与开发",
    home_svc_web_desc: "全流程网站搭建：落地页、电商站、企业官网——自适应、加载快、支持 SEO。",
    home_svc_web_feat1: "贴合品牌的定制设计",
    home_svc_web_feat2: "电脑与手机自适应",
    home_svc_web_feat3: "加载速度优化与基础 SEO",
    home_svc_web_feat4: "交付源代码，协助域名与主机",
    home_svc_web_cta: "沟通网站需求",
    home_svc_app_title: "移动应用开发",
    home_svc_app_desc: "按需定制 iOS 与 Android 应用，从创意到上架——含 TE2SR 的测试与上架服务。",
    home_svc_app_feat1: "iOS 与 Android 开发",
    home_svc_app_feat2: "符合 Apple 与 Google 规范的 UI/UX",
    home_svc_app_feat3: "对接 API、支付与推送通知",
    home_svc_app_feat4: "含测试与商店上架",
    home_svc_app_cta: "沟通应用需求",
    home_svc_aseo_title: "ASO（应用商店优化）",
    home_svc_aseo_desc: "让用户在 App Store 与 Google Play 搜索时找到你的应用：关键词、标题、描述、截图与安装转化率。",
    home_svc_aseo_feat1: "按品类与竞品做关键词调研",
    home_svc_aseo_feat2: "优化标题、副标题与描述",
    home_svc_aseo_feat3: "重新设计截图与图标",
    home_svc_aseo_feat4: "每月关键词排名报告",
    home_svc_aseo_cta: "沟通 ASO 需求",
    home_svc_wseo_title: "网站 SEO（谷歌搜索）",
    home_svc_wseo_desc: "把网站做到搜索首页：关键词调研、技术优化、SEO 内容与可持续外链建设。",
    home_svc_wseo_feat1: "技术 SEO 诊断与修复",
    home_svc_wseo_feat2: "关键词调研与内容规划",
    home_svc_wseo_feat3: "速度与 Core Web Vitals 优化",
    home_svc_wseo_feat4: "每月排名与流量报告",
    home_svc_wseo_cta: "沟通网站 SEO 需求",
    home_svc_page_title: "社媒主页代运营",
    home_svc_page_desc: "主页全托管运营：内容策划、贴文设计、稳定更新，并代为回复私信与评论。",
    home_svc_page_feat1: "每月内容日历",
    home_svc_page_feat2: "贴文设计与文案撰写",
    home_svc_page_feat3: "稳定发布，回复私信与评论",
    home_svc_page_feat4: "互动与增长报告",
    home_svc_page_cta: "沟通主页代运营",
    svc_quote_on_request: "沟通需求后报价",
    ...
    home_price_refund_fail: "若我方测试员未达到 Google 要求，全额退款",
    ...
    order_moneyback_badge: "若因我方未让 12 位测试员跑满 14 天而被 Google 判定不合格，全额退款。",
    ...
    order_service_web: "网站设计",
    order_service_appdev: "应用开发",
    order_service_aseo: "ASO",
    order_service_wseo: "网站SEO",
    order_service_page: "主页代运营",
    order_quote_req_label: "您的需求",
    order_quote_req_hint: "请描述您的想法、期望功能、时间要求与预算范围——TE2SR 工程师将在 24 小时内回复报价。",
    order_quote_no_payment: "工程师将在 24 小时内与您联系并报价。此步骤无需付款。",
