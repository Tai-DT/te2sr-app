...
// .wrangler/tmp/bundle-8WrtUC/checked-fetch.js
...
// .wrangler/tmp/bundle-8WrtUC/strip-cf-connecting-ip-header.js
...
app.post("/api/analyze-design", async (c) => {
  try {
    ...
    const report = {
      id: `RPT-${Math.floor(1e5 + Math.random() * 9e5)}`,
      fileName,
      ...
      suggestions: [
        {
          ...
          level: "Critical",
          title: "Th\u1EAFt ch\u1EB7t kho\u1EA3ng c\xE1ch v\xE0 t\u0103ng \u0111\u1ED9 n\u1ED5i b\u1EADt n\xFAt CTA (Button Prominence)",
          description: 'N\xFAt "B\u1EAFt \u0111\u1EA7u" c\xF3 \u0111\u1ED9 t\u01B0\u01A1ng ph\u1EA3n m\xE0u 3.2:1 so v\u1EDBi n\u1EC1n k\xEDnh glassmorphic. Khuy\xEAn d\xF9ng m\xE0u Neon Blue (#00D2FF) ho\u1EB7c gradient v\u1EDBi vi\u1EC1n ph\xE1t s\xE1ng 2px \u0111\u1EC3 \u0111\xE1p \u1EE9ng ti\xEAu chu\u1EA9n WCAG AAA (>= 4.5:1).'
        },
        {
          category: "Typography",
          level: "Warning",
          title: "Chu\u1EA9n h\xF3a Hierarchy ch\u1EEF gi\u1EEFa Heading v\xE0 Subtitle",
          description: "T\u1EF7 l\u1EC7 c\u1EE1 ch\u1EEF gi\u1EEFa Ti\xEAu \u0111\u1EC1 ch\xEDnh (24px) v\xE0 N\u1ED9i dung ph\u1EE5 (18px) qu\xE1 g\u1EA7n nhau. \u0110\u1EC1 xu\u1EA5t t\u0103ng font Montserrat c\u1EE7a Headline l\xEAn 32px (font-weight 700) \u0111\u1EC3 ph\xE2n c\u1EA5p th\u1ECB gi\xE1c r\xF5 r\xE0ng h\u01A1n tr\xEAn di \u0111\u1ED9ng."
        },
        {
          category: "Layout & Spacing",
          level: "Recommendation",
          title: "T\u0103ng Padding m\u1EB7t \u0111\u1ECBnh c\xE1c Card Glassmorphism",
          description: "N\u1ED9i dung th\u1EBB d\u1ECBch v\u1EE5 s\xE1t vi\u1EC1n k\xEDnh (12px padding). Theo chu\u1EA9n Stitch Lumina Nexus, card glassmorphism n\xEAn d\xF9ng t\u1ED1i thi\u1EC3u 24px - 32px padding \u0111\u1EC3 giao di\u1EC7n tho\xE1ng \u0111\u1EA1t, sang tr\u1ECDng."
        },
        {
          category: "Store Guidelines",
          level: "Warning",
          title: "Ki\u1EC3m tra t\u1EF7 l\u1EC7 M\xE0n h\xECnh \u0111\u1EE5c l\u1ED7 (Notch & Safe Area Padding)",
          description: "C\xE1c icon \u1EDF thanh header \u0111ang \u0111\xE8 l\xEAn v\u1ECB tr\xED Dynamic Island / Camera \u0111\u1EE5c l\u1ED7 tr\xEAn iOS. C\u1EA7n th\xEAm safe-area-inset-top: env(safe-area-inset-top) \u0111\u1EC3 tr\xE1nh b\u1ECB t\u1EEB ch\u1ED1i khi duy\u1EC7t tr\xEAn App Store."
        },
        {
          category: "Color & Contrast",
          level: "Recommendation",
          title: "B\u1ED5 sung hi\u1EC7u \u1EE9ng Ambient Glow cho c\xE1c ch\u1EC9 s\u1ED1 quan tr\u1ECDng",
          description: "C\xE1c tag tr\u1EA1ng th\xE1i v\xE0 ch\u1EC9 s\u1ED1 \u0111\xE1nh gi\xE1 5 sao s\u1EBD s\u1ED1ng \u0111\u1ED9ng h\u01A1n khi k\u1EBFt h\u1EE3p c\xF9ng l\u1EDBp n\u1EC1n m\u1EDD drop-shadow(0 0 12px #00D2FF40)."
        }
      ]
    };
...
// .wrangler/tmp/bundle-8WrtUC/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-8WrtUC/middleware-loader.entry.ts
